...
module "test_elasticsearch_load_balancer" {
  source                        = "./modules/loadbalancing"
  elb_name                      = "testelasticsearchlb"
  elb_security_groups           = [ module.test_elasticsearch_security_group.webapp_sec_grp_Id ]
...
module "test_elasticsearch_asg" {
  ...
  asg_lb                   = [ module.test_elasticsearch_load_balancer.webapp_elb.id ]
